        ...
        <AboutSection>
          ...
          <div className='item-card'>
            ...
            <div className='about-info'>
              ...
              <p>
                Tired of keeping and issuesing paper ticket? Hardcope of ticket
                are pounding on day by day, and more paper and storage place are
                eating up on it. That why we go paper less and print out only
                needed document.
              </p>
            </div>
          </div>
          <div className='item-card'>
            ...
            <div className='about-info'>
              ...
              <p>
                Not just keeping the document. Accessing it become easy of few
                click and with those data can give us good view on what issues
                arise the most in chart.
              </p>
            </div>
          </div>
          <div className='item-card'>
            ...
            <div className='about-info'>
              ...
              <p>
                Unpredictable issues face by user day by day, that just common
                for us. But how to keep track on user sended in the problem they
                got is the main challenge. Some by social application and some
                by calling in. That why we need to have common place to share
                the problem.
              </p>
            </div>
          </div>
